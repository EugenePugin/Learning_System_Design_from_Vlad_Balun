Задание:
- разработать system design ЯндексТакси: [hyperlink](https://github.com/EugenePugin/Learning_System_Design_from_Vlad_Balun/blob/main/Яндекс%20Такси/практика%20-%20системный%20дизайн%20Яндекс%20Такси.md)
- разработать system design социальной сети VK: [hyperlink-tbd](tbd)

Решение:
1) Требования: 
	<TODO to add an hlink to that file>
